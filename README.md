...
Specialized in modern frontend frameworks, backend microservices, cloud infrastructure, and clean architecture following SOLID principles.
...
- API Design, SOLID Principles, Design Patterns  
